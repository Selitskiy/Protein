    ...
    methods
        ...
        function net = Create(net)
            ...
            layers = [
                ...
                Pl2QLayer("Polynomial 2 Phi Q", net.k_hid2*net.n_out)
                Pl2QLayer("Polynomial 4 Phi Q", net.k_hid2*net.n_out)
                %Pl2QLayer("Polynomial 6 Phi Q", net.k_hid2*net.n_out)                
