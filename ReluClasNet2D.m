classdef ReluClasNet2D < ReluClasLayers2D & BaseClasNet2D & MLPInputClasNet2D
    ...
    methods
        function net = ReluClasNet2D(m_in, n_out, ini_rate, max_epoch)

            net = net@ReluClasLayers2D();
