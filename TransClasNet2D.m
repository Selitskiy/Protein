classdef TransClasNet2D < TransClasLayers2D & BaseClasNet2D & MLPInputClasNet2D
    ...
    methods
        function net = TransClasNet2D(m_in, n_out, ini_rate, max_epoch)

            net = net@TransClasLayers2D();
